            ...
            <div className={`shrink-0 ${accent.modalHeader} p-6 text-espresso`}>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-espresso/80 text-sm">Technologies and tools I work with</p>
                </div>
                <button
                  onClick={onClose}
                      ...
                      <div className="flex flex-wrap gap-2">
                        {category.skills.map((skill, skillIndex) => (
                          <motion.span
                            ...
                            className={`px-3 py-1.5 rounded-lg text-sm font-medium border transition-colors cursor-default ${accent.chip}`}
                          >
                            {skill}
                          </motion.span>
                        ))}
